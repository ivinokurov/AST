...
Модель AST предназначена для детекции ограждений и их теней на аэроснимках с учётом положения солнца и типа ограждения. Архитектура основана на Swin Transformer с деформируемым вниманием, раздельными полями смещения для ограждений и теней, а также механизмом перекрёстного внимания с геометрическим приором.
